...
INSERT INTO post (id, title, content, user_id, community_id, created_at) VALUES
                                                               ('post1', 'Title 1', 'Content 1', 'user1', NULL ,'2022-01-01 12:00:00'),
                                                               ('post2', 'Title 2', 'Content 2', 'user2', NULL ,'2022-01-02 13:30:00'),
                                                               ('post3', 'Title 3', 'Content 3', 'user3', NULL ,'2022-01-03 15:45:00'),
                                                               ('post4', 'Title 4', 'Content 4', 'user4', NULL ,'2022-01-04 09:15:00'),
                                                               ('post5', 'Title 5', 'Content 5', 'user1', 'group1', '2022-01-05 17:00:00'),
                                                               ('post6', 'Title 6', 'Content 6', 'user2', 'group1', '2022-01-05 17:00:00'),
                                                               ('post7', 'Title 7', 'Content 7', 'user2', 'group1', '2022-01-05 17:00:00');
